  ...
  return (
    <div className="flex flex-col md:flex-row gap-4 md:gap-6 mb-10 w-full">
      ...
      <div className="w-full md:flex-[2] flex-shrink-0">
        <Link to="/groceries" className="bg-gradient-to-r from-[#e3f4e3] to-[#f2fbf2] rounded-2xl p-6 md:p-10 flex items-center h-full min-h-[200px] overflow-hidden relative shadow-sm transition-transform duration-300 hover:shadow-md hover:scale-[1.01] group block w-full">
          ...
          <div className="absolute right-0 top-0 h-full w-3/5 md:w-2/3 overflow-hidden rounded-r-2xl">
